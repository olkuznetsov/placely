...
const dict = {
  en: {
    ...
    'home.streakShort': '{n}d',
    'home.allLived': 'All dreams lived ✦',
    'home.allLivedSub': 'Save new places to grow your deck',
    'explore.locating': 'Finding you...',
    'explore.locDenied': 'Could not get your location',
    'toast.notifSoon': 'Notifications',
    'search.clear': 'Clear search',
    'add.title': 'Add a place',
    'add.hint': 'Search the real world — powered by OpenStreetMap',
    'add.search': 'Name or address, e.g. "Khreshchatyk 22"...',
    'add.added': 'Added "{name}" to your atlas ✦',
    'add.noResults': 'Nothing found for "{q}"',
    'add.empty': 'Type at least 3 characters to search',
    'add.credit': 'Search data © OpenStreetMap contributors',
    'add.fab': 'Add a place',
    'add.delete': 'Remove this place',
    'add.deleted': 'Place removed',
    'add.mine': 'Added by you',
    'free': 'Free',
  },
  ...
  uk: {
    ...
    'home.streakShort': '{n} дн',
    'home.allLived': 'Усі мрії здійснено ✦',
    'home.allLivedSub': 'Збережи нові місця, щоб поповнити колоду',
    'explore.locating': 'Шукаю тебе...',
    'explore.locDenied': 'Не вдалося отримати локацію',
    'toast.notifSoon': 'Сповіщення',
    'search.clear': 'Очистити пошук',
    'add.title': 'Додати місце',
    'add.hint': 'Шукай справжні місця — на базі OpenStreetMap',
    'add.search': 'Назва або адреса, напр. «Хрещатик 22»...',
    'add.added': '«{name}» додано до твого атласу ✦',
    'add.noResults': 'Нічого не знайдено за запитом «{q}»',
    'add.empty': 'Введи щонайменше 3 символи для пошуку',
    'add.credit': 'Дані пошуку © спільнота OpenStreetMap',
    'add.fab': 'Додати місце',
    'add.delete': 'Видалити це місце',
    'add.deleted': 'Місце видалено',
    'add.mine': 'Додано тобою',
    'free': 'Безкоштовно',
  },
}
